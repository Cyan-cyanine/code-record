# <a id="top">[函数速查集](./FunIndex.md)</a>
<details>
<summary><strong>目录</strong></summary>
<pre>
 <a href="#C_data_struct">C_数据结构</a>
    <a href="#list">链表</a>
<a href="#C_programing">C_系统编程</a>
    <a href="#systemIo">系统IO</a>
    <a href="#standardIo">标准IO</a>
    <a href="#fileControl">文件控制</a>
    <a href="#dirIo">目录IO</a>
    <a href="#process">进程</a>
    <a href="#ipc">IPC进程通讯</a>
        <a href="#ipc_pipe">管道</a>
        <a href="#ipc_signal">信号</a>
        <a href="#ipc_msg">消息队列</a>
        <a href="#ipc_shm">共享内存</a>
        <a href="#ipc_semaphore">信号量</a>
    <a href="#thread">线程  </a>
<a href="#network">C_网络编程</a>
</pre>
</details>

## C_数据结构<a id="C_data_struct"></a>
| <a href="#top">[返回目录]</a> |        跳转        | 功能描述 | 代码示例 |
| :---------------------------- | :----------------: | :------: | -------- |
| -                             | <a href="#list">链表</a> |    链表的增删查改     | [链表增删查改](../Code/03_SystemPrograming/02_dirIo/list.c)        |
| -                             | <a href="#d">d</a> |    d     | -        |


## C_系统编程<a id="C_programing"></a>
### <a id="systemIo">系统IO</a>
...
| man 2 access                  |   <a href="#access">access</a>   |      获取文件访问权限       |                                        -                                         |
...
<a id="fseek"></a>
| <a href="#replace">fseek</a> |
| :--------------------------: |
|    ![](./asset/fseek.png)    |

<a id="ftell"></a>
| <a href="#replace">ftell</a> |
| :--------------------------: |
|    ![](./asset/ftell.png)    |
