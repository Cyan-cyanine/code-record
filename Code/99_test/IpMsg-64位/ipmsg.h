...
/*  macro  */
#define GET_MODE(command)	(command & 0x000000ffUL)	//只取低8位
#define GET_OPT(command)	(command & 0xffffff00UL)	//只取高24位

/*  header  */
#define IPMSG_VERSION			0x0001
#define IPMSG_DEFAULT_PORT		0x0979		//端口号	2425

/*  command  */
#define IPMSG_NOOPERATION		0x00000000UL	//无操作---事件同步

#define IPMSG_BR_ENTRY			0x00000001UL	//用户上线通知
#define IPMSG_BR_EXIT			0x00000002UL
#define IPMSG_ANSENTRY			0x00000003UL	//通报新上线
...
#define IPMSG_SENDMSG			0x00000020UL	//发送消息--32
#define IPMSG_RECVMSG			0x00000021UL	//接收消息确认
...
#define IPMSG_SENDCHECKOPT		0x00000100UL	//传送检查
